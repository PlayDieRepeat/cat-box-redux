...
public class UIMenuManager : MonoBehaviour
{
	...
	[SerializeField]
	private VoidEventChannelSO _exitGameEvent = default;
	...
	void SetMenuScreen()
	{
		...
		_mainMenuPanel.SetMenuScreen();
		_mainMenuPanel.ExitButtonAction += _exitGameEvent.RaiseEvent;
	...
	{
		Debugger.LogReport("ButtonWasPressed");
		if (!_hasSaveData)
		{
			ConfirmStartNewGame();
